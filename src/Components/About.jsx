...
function About() {
  return (
    <div id="about" className="w-full xl:h-screen h-fit bg-[#1a1a1a] xl:px-30 lg:px-20 md:px-10 px-5 text-white mt-30 relative overflow-hidden">
      ...
      <div className="about h-[30%] w-full mt-[3%] flex flex-col items-center justify-center">
        <p className="text-yellow-400 font-semibold mb-2 text-xs sm:text-base">Our Story</p>
        <h1 className="font-bold lg:text-4xl md:text-2xl text-xl mb-5">About PMC Barbershop</h1>
      ...
      <div className="aboutinfo flex sm:flex-row flex-col h-[60%] w-full items-center">
        <div className="leftinfo sm:w-1/2 w-full flex justify-center">
        ...
        <div className="rightinfo sm:w-1/2 w-full p-3 mt-5">
          <div className="p flex gap-3">
            <div className="line sm:h-30 h-20 w-2 bg-yellow-400"></div>
            <p className="md:text-base sm:text-sm text-xs text-zinc-600">
              Established in 2018, PMC Barbershop has been providing premium
